...
--
-- Current Database: `caja_ahorro_pujota`
--

/*!40000 DROP DATABASE IF EXISTS `caja_ahorro_pujota`*/;
...
CREATE TABLE `sesiones_mensuales` (
  ...
  `tipo` enum('ordinaria','extraordinaria','informativa') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ordinaria' COMMENT 'Tipo de sesion',
...
-- Dump completed on 2026-06-28 16:39:25
